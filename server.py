...
def process_client_request(request):
    ...
    if "merhaba" in request:
        return "Server Response:" + "merhaba size nasik yardimci olabilirim ?"
    elif "güle güle" in request.lower():
        return "Server Response: " + "görüsmek uzere"

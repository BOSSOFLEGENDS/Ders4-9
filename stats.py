...
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg # tkinter görsellestirme sinifi
...
class UserStatsApp:
    def __init__(self, root):
        ...
        self.granularity_options = ["Week", "Day", "Hours"]
    ...
    def update_statistics(self):
        ...
        if user:
            ...
            if self.granularity_var.get() == "Week":
                time_format = "%W"
            elif self.granularity_var.get() == "Day":
                time_format = "%D"
            else:
                time_format = "%H"
